                ...
                <div class="col-lg-6">
                    <div class="product-single-img">
                        <div class="product-active owl-carousel">
                            ...
                            <div class="item">
                                <img src="{{asset('honey')}}/images/product/product-details/1.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('honey')}}/images/product/product-details/2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('honey')}}/images/product/product-details/3.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('honey')}}/images/product/product-details/4.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('honey')}}/images/product/product-details/5.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('honey')}}/images/product/product-details/6.jpg" alt="">
                            </div>
                        </div>
...
<span class="pull-left">${{$product_info->product_price}}</span>
                        ...
                        <p>{{$product_info->product_short}}</p>
                        <form action="{{route('addtocart',$product_info->id)}}" method="POST">
                        @csrf
                            <ul class="input-style">
                            <li class="quantity cart-plus-minus">
                                <input type="number" value="1" name="quantity" max="{{$product_info->product_quantity}}" min="0"/>
                            </li>
                            <li>
                                
                                <button class="btn btn-danger">Add to Cart</a></li>
                        </ul>
                        </form>
                        <ul class="cetagory">
                            <li>Categories:</li>
                                ...
                                <ul>
                                    <li class="review-items">
                                        <div class="review-img">
                                            <img src="{{asset('honey')}}/images/comment/1.png" alt="">
                                        </div>
                                    ...
                                    <li class="review-items">
                                        <div class="review-img">
                                            <img src="{{asset('honey')}}/images/comment/2.png" alt="">
                                        </div>
                                        <div class="review-content">
                                    ...
                                    <li class="review-items">
                                        <div class="review-img">
                                            <img src="{{asset('honey')}}/images/comment/3.png" alt="">
                                        </div>
                                        <div class="review-content">
    ...
    <div class="featured-product-area">
        <div class="container">
            ...
            <div class="row">
@forelse($related_products as $ppp)
<div class="col-lg-3 col-sm-6 col-12">
<div class="featured-product-wrap">
<div class="featured-product-img">
<img src="{{asset('uploads/product')}}/{{$ppp->product_photo}}" alt="">
</div>
<div class="featured-product-content">
<div class="row">
<div class="col-7">
<h3><a href="{{url('product/details')}}/{{$ppp->id}}">
{{$ppp->product_name}}
</a></h3>
<p>${{$ppp->product_price}}</p>
</div>
